...
if [ ${apps[0]} == 0 ]; then
	...
	xfconf-query -c xfce4-desktop -p /backdrop/screen0/monitor0/workspace0/last-image -s "/usr/share/tealinux/wallpaper/defaults.jpg"
        echo 1 > ${file1}
else
        kill $(pgrep yad)
	...
	xfconf-query -c xfce4-desktop -p /backdrop/screen0/monitor0/workspace0/last-image -s "/usr/share/tealinux/wallpaper/Tealinux Robotic v3 - Bagus Saputra.png"
        echo 0 > ${file1}
fi
#xfce4-panel -r
